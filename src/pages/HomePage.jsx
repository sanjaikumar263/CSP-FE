    ...
    <div className="home-page-container">
      ...
      <header className="main-header">
        <div className="header-inner">
          {/* Brand Logo Image */}
          <Link to="/" className="brand-text-logo" onClick={handleClearSearch}>
        ...
        <div className="nav-inner">
          <ul className="nav-menu">
            {NAV_LINKS.map((item, idx) => (
              <li key={item.label} className={idx === 0 ? 'active' : ''}>
      ...
      <section className="heritage-section" id="heritage">
        <div className="container-inner">
          <div className="heritage-grid">
            <div className="heritage-img-column">
              <img src={heritageInfo.image} alt="Chennai Silk Palace Storefront" className="heritage-store-img" />
            </div>

            <div className="heritage-content-column">
              <div className="heritage-eyebrow">{heritageInfo.title}</div>
              <h2 className="heritage-heading">{heritageInfo.heading}</h2>
              <p className="heritage-desc">{heritageInfo.description}</p>

              <div className="heritage-stats-grid">
                {heritageInfo.stats.map((stat, i) => (
