        ...
        <div className="footer-top-grid">
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links">
              ...
              <li><Link to="/gender">Collections</Link></li>
              <li><Link to="/products">All Products</Link></li>
            </ul>
          </div>

          {/* Column 3: About & Account */}
          <div className="footer-col">
            <h4 className="footer-heading">ABOUT &amp; ACCOUNT</h4>
            <ul className="footer-links">
          ...
          <div className="footer-col contact-col">
            ...
            <div className="footer-social-links" style={{ marginTop: '16px' }}>
              <a href={storeInfo.facebook || '#'} aria-label="Facebook">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
                </svg>
              </a>
              <a href={storeInfo.instagram || '#'} aria-label="Instagram">
              ...
              <a href={storeInfo.whatsapp ? (storeInfo.whatsapp.startsWith('http') ? storeInfo.whatsapp : `https://wa.me/${storeInfo.whatsapp.replace(/[^0-9]/g, '')}`) : '#'} aria-label="WhatsApp" target="_blank" rel="noopener noreferrer">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z" />
                </svg>
              </a>
              <a href={storeInfo.youtube || '#'} aria-label="YouTube">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
